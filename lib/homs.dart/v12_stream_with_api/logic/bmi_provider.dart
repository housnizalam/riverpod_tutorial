...
class BmiLokalSpeicher {
  ...
  //   return other is BmiLokalSpeicher &&
  ...
  // @override
  // int get hashCode => groesse.hashCode ^ gewicht.hashCode ^ datum.hashCode;
  
}

class BmiStateNotifierStreamUnterricht extends StateNotifier<BmiLokalSpeicher> {
  BmiStateNotifierStreamUnterricht() : super(BmiLokalSpeicher(groesse: 180, gewicht: 80, datum: DateTime.now()));
