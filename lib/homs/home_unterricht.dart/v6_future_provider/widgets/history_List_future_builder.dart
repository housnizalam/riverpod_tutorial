...
class FutureBuilderHistoryList extends ConsumerWidget {
  const FutureBuilderHistoryList({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final bmiList = ref.watch(bmiListProvider2);
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView(
            children: [
              ...
              for (final bmi in snapshot.data!)
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Center(
                    child: Card(
